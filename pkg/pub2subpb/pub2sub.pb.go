...
func (m *UDPUnreliableMessage) GetServerId() string {
	if m != nil {
		return m.ServerId
	}
	return ""
...
func (m *StreamMessageEvent) GetServerId() string {
	if m != nil {
		return m.ServerId
	}
	return ""
...
func (m *AckRequest) GetServerId() string {
	if m != nil {
		return m.ServerId
	}
	return ""
...
func (m *LeaseResponse) GetExists() bool {
	if m != nil {
		return m.Exists
	}
	return false
...
func (m *RevokeLeaseRequest) Reset()                    { *m = RevokeLeaseRequest{} }
func (m *RevokeLeaseRequest) String() string            { return proto.CompactTextString(m) }
func (*RevokeLeaseRequest) ProtoMessage()               {}
func (*RevokeLeaseRequest) Descriptor() ([]byte, []int) { return fileDescriptorPub2Sub, []int{23} }

func (m *RevokeLeaseRequest) GetChannelId() string {
	if m != nil {
		return m.ChannelId
	}
	return ""
...
func (m *RevokeLeaseRequest) GetTopicId() string {
	if m != nil {
		return m.TopicId
	}
	return ""
...
func (m *RevokeLeaseResponse) Reset()                    { *m = RevokeLeaseResponse{} }
func (m *RevokeLeaseResponse) String() string            { return proto.CompactTextString(m) }
func (*RevokeLeaseResponse) ProtoMessage()               {}
func (*RevokeLeaseResponse) Descriptor() ([]byte, []int) { return fileDescriptorPub2Sub, []int{24} }
...
func init() {
	...
	proto.RegisterType((*RevokeLeaseRequest)(nil), "pub2sub.RevokeLeaseRequest")
	proto.RegisterType((*RevokeLeaseResponse)(nil), "pub2sub.RevokeLeaseResponse")
...
func (c *subscribeServiceClient) RevokeLease(ctx context.Context, in *RevokeLeaseRequest, opts ...grpc.CallOption) (*RevokeLeaseResponse, error) {
	out := new(RevokeLeaseResponse)
	err := grpc.Invoke(ctx, "/pub2sub.SubscribeService/RevokeLease", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SubscribeService_RevokeLease_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RevokeLeaseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SubscribeServiceServer).RevokeLease(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pub2sub.SubscribeService/RevokeLease",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SubscribeServiceServer).RevokeLease(ctx, req.(*RevokeLeaseRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _SubscribeService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SubscribeService_RevokeLease_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
...
func (m *RevokeLeaseRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RevokeLeaseRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *RevokeLeaseResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RevokeLeaseResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *RevokeLeaseRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.ChannelId)
	if l > 0 {
...
func (m *RevokeLeaseResponse) Size() (n int) {
	var l int
	_ = l
	return n
}
...
func (m *RevokeLeaseRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RevokeLeaseRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RevokeLeaseRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RevokeLeaseResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RevokeLeaseResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RevokeLeaseResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
var fileDescriptorPub2Sub = []byte{
	...
	,
}
